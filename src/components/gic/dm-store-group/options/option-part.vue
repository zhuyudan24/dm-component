  ...
  methods: {
    ...
    getLeftList() {
      return new Promise((resolve, reject) => {
        ...
        this.axios
          .post(baseUrl + '/api-plug/query-store-by-code-name-new?requestProject=gic-clique', qs.stringify(this.leftParams))
          .then(res => {
    ...
    getRightList() {
      return new Promise((resolve, reject) => {
        ...
        this.axios
          .post(baseUrl + '/api-plug/list-right-data?requestProject=gic-clique', qs.stringify(this.rightParams))
          .then(res => {
    ...
    saveToRight() {
      ...
      this.saveParams.search = this.leftParams.saveParams || '';
      if (this.saveParams.isAll) {
      ...
      this.axios
        .post(baseUrl + '/api-plug/save-store-widget?requestProject=gic-clique', qs.stringify(this.saveParams))
        .then(res => {
          this.rightParams.currentPage = 1;
          if (!this.isAdd) {
