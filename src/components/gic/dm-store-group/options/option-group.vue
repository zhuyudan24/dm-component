  ...
  <el-popover class="vertical-baseline" placement="bottom-start" width="446" height="378" trigger="click" v-model="popoverShow">
    <div class="dm-store__wrap" style="height: 378px;">
      ...
      <div class="dm-store__left">
        ...
        <el-tree check-strictly ref="tree" class="dm-store__list" :data="leftList" :default-expand-all="true" show-checkbox node-key="storeGroupId" :props="defaultProps"></el-tree>
      </div>
  ...
  methods: {
    ...
    getLeftList() {
      return new Promise((resolve, reject) => {
        this.axios
          .get(baseUrl + '/api-plug/clique-store-group-list?requestProject=gic-clique&search=' + this.leftValue)
          .then(res => {
